...
public class TicketOfferManagerTest {
    ...
    public void shouldFindTwoTicketOffer() {
        ...
        TicketOffer[] expected = new TicketOffer[]{sixth, second};
    ...
    public void shouldFindFourTicketsOffer() {
        ...
        TicketOffer[] expected = new TicketOffer[]{first,  eighth, ninth, seventh};
        TicketOffer[] actual = manager.searchBy("LED", "KUF");
    ...
    public void shouldRemoveByIdOneTicket() {
        ...
        TicketOffer[] expected = new TicketOffer[]{first, third, fourth, fifth, sixth, seventh, eighth,
                ninth, tenth};
